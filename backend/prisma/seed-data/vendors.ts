export const vendors = [
  ...
  },
  {
    ...
    email: 'billing@northstarcoworking.ma',
    phone: '+212600000011',
    website: 'https://northstarcoworking.ma',
    notes: 'Flexible workspace and meeting room provider.',
  },
  {
    name: 'Riad Business Travel',
    email: 'bookings@riadbusinesstravel.ma',
    phone: '+212600000012',
    website: 'https://riadbusinesstravel.ma',
    notes: 'Business travel and accommodation agency.',
  },
  {
    name: 'SecureNet Systems',
    email: 'accounts@securenetsystems.ma',
    phone: '+212600000013',
    website: 'https://securenetsystems.ma',
    notes: 'Network security and managed IT services.',
  },
  {
    name: 'Cedar Office Furniture',
    email: 'sales@cedarofficefurniture.ma',
    phone: '+212600000014',
    website: 'https://cedarofficefurniture.ma',
    notes: 'Desks, chairs, and office storage supplier.',
  },
  {
    name: 'Harbor Conference Center',
    email: 'events@harborconference.ma',
    phone: '+212600000015',
    website: 'https://harborconference.ma',
    notes: 'Conference rooms and corporate event services.',
  },
  {
    name: 'Legacy Telecom Services',
    email: 'billing@legacytelecom.ma',
    phone: '+212600000016',
    website: 'https://legacytelecom.ma',
